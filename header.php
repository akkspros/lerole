...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'lerole' ); ?></a>

	<nav class="navbar" role="navigation" aria-label="<?php esc_attr_e( 'Main Navigation', 'lerole' ); ?>">
		<div class="container">
			...
			<div id="main-menu" class="navbar-menu">
				<div class="navbar-end">
					...
					wp_nav_menu( array(
						...
						'menu_class'      => '',
						'menu_id'         => '',
						'fallback_cb'     => 'lerole_primary_navigation_fallback',
						'items_wrap'      => '%3$s',
						'depth'           => 2,
		...
		<section class="hero is-light" style=" <?php echo esc_attr( $extra_style ); ?>">
			<div class="hero-body">
				<div class="container has-text-centered">
					...
					?>
					<?php
					$lerole_description = get_bloginfo( 'description', 'display' );
					if ( $lerole_description || is_customize_preview() ) :
						?>
						<p class="site-description subtitle"><?php echo $lerole_description; /* WPCS: xss ok. */ ?></p>
					<?php endif; ?>
				</div>
			</div>
		</section>
